...
public:
    ...
    string getItemCategory() { return category; }
    int getItemPrice() { return price; }
    int getItemQuantity() { return quantity; }
    int getItemBought() { return bought; }
    string getItemSeller() { return sellerUsr; }
private:
    int id;
    string name;
    string sellerUsr;
...
public:
    ...
    int getDelevCost() { return deliveryCost; }
